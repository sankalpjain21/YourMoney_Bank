...
import os                   #creating directories Admin/Customer
...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to YOURMONEY BANK")
        p1 = PhotoImage(file='bank1.png')
...
class Error:
    def __init__(self, window=None):
        ...
        global _img0
        _img0 = tk.PhotoImage(file="error_image.png")
...
class adminLogin:
    def __init__(self, window=None):
        ...
        global _img0
        _img0 = tk.PhotoImage(file="adminLogin1.png")
        ...
        global _img1
        _img1 = tk.PhotoImage(file="user1.png")
        ...
        global _img2
        _img2 = tk.PhotoImage(file="lock1.png")
        ...
        global _img3
        _img3 = tk.PhotoImage(file="bank1.png")
        ...
        global admin_img
        admin_img = tk.PhotoImage(file="adminLogin1.png")
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        Label2.place(relx=0.067, rely=0.283, height=181, width=233)
        global _img0
        _img0 = tk.PhotoImage(file="customer.png")
        Label2.configure(image=_img0)
        ...
        global customer_img
        customer_img = tk.PhotoImage(file="customer.png")
...
class adminMenu:
    def __init__(self, window=None):
        ...
        self.Button4 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 ...
                                 font="-family {Segoe UI} -size 11", foreground="#fffffe",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
                                 text="Create Employee account", command=self.createAdmin)
        ...
        self.Button5 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 ...
                                 font="-family {Segoe UI} -size 11", foreground="#fffffe",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
                                 text="Close Employee account", command=self.deleteAdmin)
